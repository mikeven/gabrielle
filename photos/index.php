    ...
    <div id="wrapper">
        ...
        <div id="entercode" class="sectionphoto">
            <div class="row nomargin">
                ...
                <div class="col-md-6 col-xs-12 col-sm-6 text-center wow fadeIn" 
                    data-wow-duration="500ms" data-wow-delay="300ms" align="center">
                    <div align="center">
                        <img src="../images/GABRIELLE CHANEL.png" class="gabrielle_logo">
                    </div>
                    <div align="center">
                        <img src="../images/essence.png" width="50%">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-12">
                        ...
                        <a id="showcode" href="#!" data-toggle="modal" data-target="#win_codigo_foto"></a>

                        <!-- Modal -->
                        <div class="modal bd-example-modal-md" id="win_codigo_foto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div id="mygab" class="modal-dialog modal-md" role="document">
                            <div class="modal-content">

                              <div class="modal-body" align="center">
                                <div align="center" style="padding: 5px 0">
                                  <span class="social_inv">Para descubrir su foto use el siguiente código</span>
                                </div>
                                <div align="center" style="padding: 5px 0">
                                  <span class="social_inv" id="phcode"></span>
                                </div>
                              </div>
